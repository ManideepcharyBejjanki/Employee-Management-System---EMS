...
* Using Spring Boot instead of Hibernate
* Using Angular instead of HTML/CSS/JS

## Getting Started
   
*(https://github.com/ManideepcharyBejjanki/Project1.git)
...
## Usage
> This Project is used to develop a simple webapplication that includes basic Resistration , Login, Edit, Delete pages.
